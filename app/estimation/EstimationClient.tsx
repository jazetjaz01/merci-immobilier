      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-28 items-start">
        ...
        <div className="flex flex-col order-2 md:pl-8 mt-0 md:mt-10">
          <div className="max-w-xl">
            <h1 className="flex flex-col leading-tight mb-4">
              <span className="text-4xl md:text-5xl font-medium text-slate-800">Obtenez</span>
              <span className="text-4xl md:text-5xl font-medium text-slate-800">
